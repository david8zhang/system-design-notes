...
In this section, we'll take a look at some formats for storing data examining the pros and cons of each. We'll also look at some frameworks for encoding the data to be sent over the network.
